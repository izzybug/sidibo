...
if (isset($_POST['add_student'])) {
    ...
    $query = "INSERT INTO tblemployees (FirstName, LastName, EmailId, Password, Gender, Dob, Department, Address, NIM, Status, role, location)
              VALUES ('$fname', '$lname', '$email', '$password', '$gender', '$dob', '$department', '$address', '$NIM', $status, '$user_role', '../vendors/images/logo-poltek.png')";
