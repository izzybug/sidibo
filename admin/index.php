			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$status=1;
						$sql = "SELECT kti_id from tblpengajuan where status=:status";
						$query = $dbh -> prepare($sql);
						...
						<div class="user-list">
							<ul>
								...
								<li class="d-flex align-items-center justify-content-between">
									...
									<div class="font-12 weight-500" data-color="#17a2b8"><?php echo $row['NIM']; ?></div>
								</li>
								<?php }?>
							</ul>
						</div>
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php $sql = "SELECT tblpengajuan.kti_id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblpengajuan.Keperluan,tblpengajuan.PostingDate,tblpengajuan.Status from tblpengajuan join tblemployees on tblpengajuan.empid=tblemployees.emp_id order by lid desc limit 5";

								// query untuk menampilkan hanya staff/students
								// $sql = "SELECT tblpengajuan.kti_id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblpengajuan.Keperluan,tblpengajuan.PostingDate,tblpengajuan.Status from tblpengajuan join tblemployees on tblpengajuan.empid=tblemployees.emp_id where tblemployees.role = 'Staff' order by lid desc limit 5";
									$query = $dbh -> prepare($sql);
									$query->execute();
									$results=$query->fetchAll(PDO::FETCH_OBJ);
									$cnt=1;
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="detail_pengajuan.php?leaveid=<?php echo htmlentities($result->lid);?>"><i class="dw dw-eye"></i> View</a>
