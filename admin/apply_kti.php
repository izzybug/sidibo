...
if (isset($_POST['apply'])) {
    ...
    try {
        $sql = "INSERT INTO tblpengajuan (FirstName, LastName, NIM, ProgramStudi, Keperluan, JudulProposal, WaktuPenelitian, TempatPenelitian, PostingDate, Status,  IsRead, empid) 
                VALUES (:FirstName, :LastName, :NIM, :ProgramStudi, :Keperluan, :JudulProposal, :WaktuPenelitian, :TempatPenelitian, :PostingDate, :Status, :IsRead, :empid)";
        ...
        if ($lastInsertId) {
            ...
            echo "<script type='text/javascript'> document.location = 'pengajuan.php'; </script>";
        } else {
							...
							<section>
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>NIM :</label>
											<input name="NIM" type="text" class="form-control" required="true" autocomplete="off" maxlength="20">
										</div>
									</div>
								</div>
								<div class="row">
